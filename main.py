...
LORE_FACTS = [
    ...
    "Интересный факт: Майя Сундареш, ныне известная как Дирижёр, перерождалась целых два раза! Сначала она умерла на Неомуне,
    попытавшись связаться с вуалью, затем её разум был перемещен в экзо-тело "Лакшми-2", но и в этой оболочке она умерла в ходе нападения вексов на башню.",
    ...
    "Грустный факт: многие могли не заметить, но Буря и Натиск связаны не только механикой, но и лорами. У обоих оружий в кратком описании написано, для кого они. Буря для Сигрун от Виктора,
    а Натиск для Виктора от Сигрун. Они были парой, но их разделила судьба. Виктор был в криосне на борту "Исхода", а Сигрун опоздала на этот корабль и не могла больше погрузиться в криосон.",
