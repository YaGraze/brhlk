...
SAFE_PHRASES = [
    "Странник избрал тебя. Живи пока. (шанс 1 к 4).",
    "У тебя что, 100 Здоровья? Пуля отскочила. (шанс 1 к 4).",
    "Призрак успел тебя воскресить. Повезло. (шанс 1 к 4).",
    "Рандом на твоей стороне, Страж. ЛВ осечку дал. (шанс 1 к 4).",
    "Ты увернулся, как Хант с перекатом. Заряжаем ЛВ заново? (шанс 1 к 4)."
]
...
BAD_WORDS = ["пидор", "пидорас", "лгбт", "цп", "казино", "цп", "child porn", "cp", "закладки", "мефедрон", 
    "соль", "шишки", "гашиш", "купить скорость" "чурка", "хач", "ниггер", "хохол", "кацап", 
    "москаль", "свинособак", "черномаз", "нига", "нигга", "nigga", "nigger", "hohol", 
    "магазин 24/7", "hydra", "kraken", "убейся", "выпей яду", "роскомнадзорнись", 
    "мать твою", "мамку ебал", "Путин", "Зеленский", "война", "вата", "либераха", "гейропа", "кокс", "фашист"] 
